...
from app.schemas.product_schema import ProductCreate, ProductManageResponse, ProductUpdate
...
@router.post("/", response_model=ApiResponse[ProductManageResponse], status_code=status.HTTP_201_CREATED)
...
@router.patch("/{id}/images", response_model=ApiResponse[ProductManageResponse])
...
@router.patch("/{id}", response_model=ApiResponse[ProductManageResponse])
@user_limiter.limit("10/minute")
...
@router.post("/{id}/variants", response_model=ApiResponse[ProductManageResponse])
@user_limiter.limit("10/minute")
...
@router.patch("/{id}/variants/{sku}", response_model=ApiResponse[ProductManageResponse])
@user_limiter.limit("10/minute")
...
@router.delete("/{id}/variants/{sku}", response_model=ApiResponse[ProductManageResponse])
@user_limiter.limit("10/minute")
